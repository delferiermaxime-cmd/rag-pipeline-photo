...
async def stream_rag_response(
    ...
    user_id: str,
    model: str,
    http_client: httpx.AsyncClient,   # FIX : client partagé injecté depuis app.state
    ...
    # 3. Envoi des sources (FIX : .get() défensif sur tous les champs)
    sources = [
        {
    ...
    # 4. Stream LLM (FIX : timeout adapté SSE — read=None, pas de limite)
